...
- **[Medicinal Mushroom Compound × Chokepoint Mapping (comp-014)](wiki/medicinal-mushroom-compound-mapping-computational.md)** — Partial compound/source/target lead inventory; no candidate rank or comprehensive coverage claim survives.
...
- **[Medicinal Mushroom Compound Mapping (comp-014)](wiki/medicinal-mushroom-compound-mapping-computational.md)** — Partial fungal compound/source/target lead inventory; database gaps and open nodes require primary-source qualification.
...
- **[DAF/CD55 Protease Proxy (comp-006)](wiki/daf-cd55-protease-stability-computational.md)** — The HIGH label is an invalid pLDDT-accessibility proxy; the Ser/Thr-rich stalk remains a testable engineering liability, not a demonstrated degradation site.
