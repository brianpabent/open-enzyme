...
- **[DAF/CD55 Protease Proxy (comp-006)](wiki/daf-cd55-protease-stability-computational.md)** — The HIGH label is an invalid pLDDT-accessibility proxy and the score does not discriminate the tested sequence scopes; the Ser/Thr-rich stalk remains a testable engineering liability, not a demonstrated degradation site.
