...
| siRNA-2 | COMP-048 human proximal-tubule delivery-handle screen | $0 | TBD | Whether any plausibly internalizing surface receptor is selective enough for receptor-targeted delivery work; guide design follows only if delivery survives |
...
- **[Uricase Cassette Search Space (comp-022, corrective review open)](wiki/uricase-cassette-ranking-computational.md)** — Enumerated cassette hypotheses; the current shortlist is non-authoritative because one ranking axis uses uncalibrated coefficients.
