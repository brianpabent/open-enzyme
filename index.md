...
- **[Compounding Pharmacy Track](wiki/compounding-pharmacy-track.md)** — peer track for **delivery, not chassis**: turn the discovery-engine repurposing surface into patient access via 503A / 503B compounding pharmacies. Lowest engineering effort of any peer track (formulation-engineering only, no genetics). MINX-style pattern: AI-aided formulation review + lipid-matrix release-control design + compounding pharmacy + dissolution testing → days, not years. Cleavage rule: small-molecule + FDA-approved API + off-patent / off-label → compoundable; proteins / enzymes / biologics stay on the fermentation chassis. Highest-priority candidate is disulfiram (CP6b GSDMD inhibitor — already FDA-approved for AUD; mechanism documented in `disulfiram.md`); colchicine custom doses, allopurinol custom doses, probenecid combos, zileuton, and pentostatin/cordycepin pairing are secondary candidates. 7 Phase 2 follow-ups queued (bulk API audit, pharmacy partner ID, physician partner pathway, USP characterization library, insurance reality, disulfiram dose modeling comp-NNN, sweep-daemon discovery-engine hook). (source: compounding-pharmacy-track.md)
...
- **[Hypotheses Index](wiki/hypotheses/README.md)** — Committed scientific claims in Falsification Card form. H01 Ward dual-cassette (koji endgame gate); H02 Engineered LBP thesis (stub); H03 siRNA/URAT1 thesis (stub); H04 TCM × Modern Rigor methodology lens (stub, committed 2026-05-05); **H05 DAF SCR1-4 CP0-closure thesis (stub, committed 2026-05-05) — in silico-validated fermentable CP0 engineering candidate; three wet-lab unknowns remain**; **H06 Medicinal Mushroom Complement Track (stub, committed 2026-05-06) — three falsification dimensions: cultivation reproducibility, extract characterization robustness, in vivo effect-size replication**; **H07 Clomid Intestinal-ER Antagonism (stub, committed 2026-05-07) — proposes clomiphene's UA-elevating effect is mediated by intestinal ER antagonism blocking the female-positive PI3K/Akt → ABCG2 induction signal, not by direct AR effects on intestinal ABCG2; sub-claims 1 + 3 partially tested by comp-017 Tier-0 killshot**.
- **[Computational Experiments](wiki/computational-experiments.md)** — Tracking index for all computational analyses (comp-001 through comp-017). comp-001: uricase shio-koji protease stability (LOW risk — reframes §1.10 uricase arm as confirmation experiment); comp-004: supplement ABCG2 antagonism (VERY HIGH risk for quercetin/curcumin at supplement doses); comp-005: lactoferrin shio-koji protease stability (HIGH/MODERATE — signal-peptide-contingent); comp-006: DAF/CD55 ectodomain protease stability (HIGH — stalk-contingent; SCR1-4 core is LOW); comp-007: food-grade HDAC inhibitor screen (butyrate rank 1, 167× HDAC6 selectivity confirmed); **comp-010: dual-cassette cassette compatibility (LOW overall risk — no blocking issues; KEX2 pos 579 moderate risk in Lf; uricase C-terminal SKL PTS1 verify; combined ER burden 1.06× Huynh 2020 baseline)**; **comp-011: *C. utilis* uricase cassette compatibility (MODERATE — codon burden HEAVY, 4 free Cys, 2 internal KR sites; manageable with gene synthesis + SDS-PAGE QC; ALLN-346 mutations recommended)**; **comp-012: DAF/CD55 SCR1-4 truncated protease stability (LOW — max 0.039, identical to uricase; stalk truncation removed 100% of exposed sites; CP0 platform gap now "active engineering candidate")**; **comp-013: TCM gout compound triage (4 GUT-LUMINAL VIABLE: luteolin, astilbin, emodin, berberine; 1 MODERATE: rhein; 4 MECHANISM UNCLEAR; ChEMBL coverage gap is load-bearing for TCM compounds)**; **comp-014: medicinal mushroom compound × chokepoint mapping (Phase 2 ChEMBL+LOTUS+PubMed complete; GLPP+cordycepin synergy pair flagged; C5aR1 platform gap confirmed empirically; two new chokepoint candidates: ADA + PINK1/mitophagy)**; **comp-015: T-axis adjuvant urate-target mapping v2 (cordycepin GOUT-FAVORABLE; eurycomanone GOUT-FAVORABLE — REVERSED v1→v2; icariin MECHANISM-UNCLEAR; echinacoside MECHANISM-UNCLEAR; XO added as 5th target; H-AN-02 PARTIALLY FALSIFIED)**; **comp-016: T × intestinal ABCG2 suppression evidence mining (WEAK / UNCONFIRMED — zero primary studies demonstrate direct androgen-driven intestinal ABCG2 suppression; mechanism reframed to estradiol-positive female arm)**; **comp-017: intestinal ABCG2 sex-dimorphism public-data mining + 4-paper full-text re-read (NULL OR NEAR-NULL sex-dimorphism at healthy baseline; Hoque 2020 78% Western-jejunum / 88% combined; Yu 2021 100 µM pharmacological tier; Klyushova 2023 PXR/FXR xenobiotic response; MacLean 2008 null strengthened; Hosoyamada 2010 URAT1 protein null surfaced)**. (source: computational-experiments.md)
- **[Cordycepin Cassette Metabolic Burden (comp-023)](wiki/cordycepin-cassette-burden-computational.md)** — FBA on Vongsangnak 2008 iWV1314 GEM evaluating whether the cns1+cns2 cordycepin biosynthesis pathway (Jeennor 2023, 564 mg/L/d in *A. oryzae*) imposes prohibitive metabolic burden on top of the dual uricase + lactoferrin cassette. **Verdict: GREEN** — growth penalty +0.02% vs WT, kojic + EGT yield headroom 100% of dual-cassette baseline, FBA breakpoint ~1,000× the empirical titer. Closes the cytosolic-proteome-burden gap that [chaperone-orthogonal-stacking.md](wiki/chaperone-orthogonal-stacking.md) line 238 flags as out-of-scope. Carnosine + panD third-cassette alternatives also GREEN. v1 limitation: plain FBA, not pcSec; ER folding axis covered separately by chaperone framework. (source: cordycepin-cassette-burden-computational.md)
