...
**Already resolved.** The comp-018 "chokepoint-hacker move worked" vs comp-014 "empty chokepoints" tension is documented + resolved in `medicinal-mushroom-compound-mapping-computational.md` §"Phase 3 NLRP3 empty chokepoint reversal": the chokepoints were query-framing-empty, not biology-empty; partial contradiction, not full refutation (worked for CP0, did not transfer to NLRP3). No new wiki work. Closure.
