...
comp-042 reframed this experiment: the naive fluorescent-KPV uptake design is **PepT1-confounded** — a positive signal can't distinguish pore-delivery from KPV's constitutive PepT1 uptake ([Dalmasso 2008, PMID 18061177](https://doi.org/10.1053/j.gastro.2007.10.026)). Logged the **redesigned** experiment as [`validation-experiments.md` §1.32](../../wiki/validation-experiments.md) — a transporter-orphan membrane-impermeant tracer (± PepT1-blockade control), which cleanly isolates the pore contribution and tests the general thesis rather than the wrong molecule. KPV-specific efficacy work deprioritized; §1.32 supersedes the naive Tier-1 precursor on the paradox page. Cost/timeline (~$2–5K, 4–6 wk) preserved.
