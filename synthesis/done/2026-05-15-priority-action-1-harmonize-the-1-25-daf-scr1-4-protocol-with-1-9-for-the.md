...
## ✓ Already actioned 2026-05-15 (closure note — duplicate of Item 26)

Pass 3's "Push back" verdict is identical to the verdict it gave on Item 26 (2026-05-15 Connection 3) — same harmonization-already-documented finding, this time framed as a Priority Action instead of a Connection.

Verified again by grep:
- ✓ `wiki/validation-experiments.md` §1.25 line 969 carries the calibration-set conditional harmonization rule verbatim
- ✓ `wiki/validation-experiments.md` §1.9 line 327 mirrors on the lactoferrin transferrin-lobe side
- ✓ `wiki/chaperone-orthogonal-stacking.md` §3.5.4 defines the calibration set + required harmonization conditions

No new wiki work needed. The "update §1.25" action Pass 2 proposed is structurally already in the protocol. Closing.
