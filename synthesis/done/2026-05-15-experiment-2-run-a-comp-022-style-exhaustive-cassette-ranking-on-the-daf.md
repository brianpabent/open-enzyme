...
- Output artifacts the agent will produce: `experiments/comp-030-daf-cassette-ranking/` (README, provenance, code, results, figures) + `wiki/daf-cd55-scr14-cassette-ranking-computational.md` wiki write-up + cross-link updates on `daf-cd55-scr14-truncated-computational.md` (comp-012) and `validation-experiments.md` §1.25.
