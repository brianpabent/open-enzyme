...
Same root assumption: the framework's per-architecture α coefficients (CCP/SCR 0.3–0.6, transferrin-lobe 1.5–2.5) are uncalibrated against koji solid-state fermentation. The 05-17 sweep restated this exact concern as "single load-bearing belief least supported by the corpus" — that's the canonical entry. D4 closed as "already prioritized in §1.9 + §1.25 paired calibration set; gates on wet-lab budget." Full closure context in the canonical entry.
