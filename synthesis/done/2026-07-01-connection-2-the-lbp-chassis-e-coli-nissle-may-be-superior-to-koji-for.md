...
Ran **comp-043** ([`daf-lactoferrin-ecn-folding-feasibility-computational.md`](../../wiki/daf-lactoferrin-ecn-folding-feasibility-computational.md)) — a comp-006/comp-037-style folding-feasibility analysis (the correctly-shaped test, not the card's proposed GEM). Result **refutes** "EcN superior to koji for PDI-heavy payloads" as stated: crossover at DAF SCR1-4 (8 disulfides) — C1-INH (2) VIABLE, DAF SCR1-4 (8) PROVISIONAL, lactoferrin (16) NOT-VIABLE; koji not dominated (folds DAF at LOW risk per comp-012, >2 g/L lactoferrin precedent Ward 1995); glycosylation is NOT the filter (folding is). Documented the bounded thesis in [`engineered-lbp-chassis.md`](../../wiki/engineered-lbp-chassis.md) §"EcN as a disulfide-folding chassis" + recorded the EcN DsbA/DsbC capacity gap as [`chaperone-orthogonal-stacking.md`](../../wiki/chaperone-orthogonal-stacking.md) §8 item 8. Two-chassis CP0 architecture strengthened, not replaced.
