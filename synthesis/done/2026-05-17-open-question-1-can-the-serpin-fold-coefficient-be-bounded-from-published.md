...
**WALKED 2026-05-19 — Closed (duplicate of [[2026-05-17-connection-4-the-serpin-fold-architecture-is-absent-from-the-chaperone]]).**

Same lit-scan question framed as an open-question card. Subagent firing in background during the 2026-05-19 walkthrough; provisional bound (α 0.5–1.5) already encoded in `chaperone-orthogonal-stacking.md` §3.5.2 pending refinement from the published-folding-kinetics literature. Full closure context in the canonical entry.
