...
**Closure (action absorbed):** Same action as Connection #2 above — §4 C5a row + §13 pre-flare baseline updated 2026-05-22 with event-linked omega-3 index timing + CFH 402H stratification annotation. See `2026-05-21-connection-2-the-c5a-decline-slope-prediction-...md` actioned annotation for the detailed change log.

The protocol-tightening + genotype-annotation framing per Pass 3 is exactly what landed. No separate $50 add-on filing.
