...
**Cross-references.** Experiment folder: [`experiments/comp-032-abcg2-q141k-chaperone-screen/`](../experiments/comp-032-abcg2-q141k-chaperone-screen/). Platform context: [`abcg2-modulators.md` §"Pharmacological-chaperone route"](./abcg2-modulators.md) and [`chassis-pending-interventions.md` §7](./chassis-pending-interventions.md). Delivery route: [`compounding-pharmacy-track.md`](./compounding-pharmacy-track.md). Orthogonal HDAC/butyrate rescue track: [`purine-degrading-bacteria.md`](./purine-degrading-bacteria.md).
