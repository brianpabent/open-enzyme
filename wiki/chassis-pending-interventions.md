...
**Key biochemistry gap — H₂O₂ diffusion-vs-catalase-scavenging math (added 2026-05-16).** The route's central safety question is whether spatial confinement (Pickering emulsion / fusion protein / nanoparticle co-encapsulation / free co-formulated catalase) closes the H₂O₂ diffusion gap tightly enough to keep tissue-local steady-state [H₂O₂] below the synovial-tissue damage threshold. A 2026-05-16 focused literature scan confirmed **this reaction-diffusion analysis is missing from every published architecture paper.** The Liu 2025 *J Nanobiotechnology* Pickering emulsion paper (PMID 41390400) — the strongest candidate — reports FRET >85% (donor-acceptor distance <10 nm), interfacial enzyme densities, and dissolved-O₂ kinetics, but stops short of computing predicted steady-state H₂O₂ escape flux. Other architecture papers (Lin 2022 Pt/CeO₂ nanozyme PMID 34968071; Liu 2025 *Nat Commun* hollow nanomotor PMID 40057522; Jung 2017 UOX+AuNP cascade PMID 28287162) similarly assert safety qualitatively via in vivo histology / cell viability without the diffusion math. The synovial-tissue toxicity threshold itself is weakly anchored — Schalkwijk 1986/87 (PMID 3707631) is the canonical IA H₂O₂ damage model but reports injected GOx dose, not steady-state [H₂O₂]; in vitro chondrocyte papers use bolus 100 µM–2 mM as documented-toxic; sub-10 µM is presumptively tolerable; the band between is unmodeled. **[comp-035](./computational-experiments.md) is in flight** — computing Damköhler-number reaction-diffusion analysis across the three architectures (Pickering emulsion, fusion protein, free co-formulated) against the literature-derived toxicity threshold band. Verdict per architecture will land here on completion. Until then, the chassis-pending status holds and any chassis-selection decision must explicitly account for the H₂O₂ housekeeping unknown.

**Cross-reference.** [`delivery-route-matrix.md`](./delivery-route-matrix.md), [`gout-kill-chain-delivery-routes.md`](./gout-kill-chain-delivery-routes.md), [`engineered-koji-protocol.md` §"The Hydrogen Peroxide Question — and why the chassis solves it for free"](./engineered-koji-protocol.md), [comp-035](./computational-experiments.md) (H₂O₂ reaction-diffusion analysis, in flight).
