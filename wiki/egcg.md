...
**Current track position on EGCG:** Dietary / supplement candidate, not a production target. Green tea already provides a mature agricultural production route. The practical engineering question is **bioavailability enhancement**, not microbial biosynthesis—phospholipid complexes, lipid-nanoparticle encapsulation, and COMT-inhibitor co-formulation are the relevant levers.
