---
title: "Duckweed (Lemnaceae) as an Edible Biomanufacturing Chassis"
date: 2026-05-29
tags:
  - chassis-class
  - duckweed
...
sources:
  - "Tek, Villot, Michaud, Torkamaneh — 'Duckweed biomanufacturing: longstanding promise, decade-long lag, recent renaissance.' Trends in Biotechnology (2026), Opinion. S0167-7799(26)00191-5"
  - "'Duckweeds: from fundamental biology to a sustainable plant chassis for biotechnology.' Advanced Biotechnology (2026), DOI 10.1007/s44307-026-00110-1"
  - "Wang et al. 2014, Spirodela polyrhiza genome, Nat Commun 5:3311 (158 Mb, ~19,623 genes, ~9% global methylation)"
  - "Cox et al. 2006, Nat Biotechnol 24:1591 (nbt1260) — humanized-glycan mAb in Lemna minor; up to 50× ADCC vs CHO"
  - "Yang et al. 2021, 'Research Progress of a Potential Bioreactor: Duckweed,' Biomolecules 11:93 (PMC7828363) — recombinant-protein yield table"
  - "Tan et al. 2022, Biomolecules 12:1881 (CAS Chengdu) — Lemna minor 86–88% stable transformation; IL-17B oral mucosal adjuvant in chickens"
  - "Yan et al. 2013, Food Chem 141:3766 (PMID 23993547) — luteolin XO IC50 4.79±0.02 µM, Ki 2.38±0.05 µM, competitive (allopurinol control IC50 1.84 µM)"
  - "Duckweed IBV edible vaccine, Plant Biotechnol J 2025 (PMID 40671256) — 100% protection, chickens, oral, mucosal sIgA"
  - "Wolffia globosa LamB fish vaccine, Front Immunol 2020 (PMC7468452) — 63.3% relative percent survival, oral"
  - "'Duckweed Dip,' ACS Synth Biol 2024 (PMC10877602) — CNT-DNA passive uptake, transient/reporter-only, S. polyrhiza"
  - "FDA GRN 742 (Parabel/Lentein duckweed powder, no-objection 2018); EFSA 2021 W. globosa novel-food opinion (manganese rejection, EFSA Journal pub 6938)"
  - "Protalix taliglucerase alfa / Elelyso — FDA approved 2012, carrot-cell recombinant enzyme (plant-made injectable precedent)"
  - "Biolex Therapeutics LEX System (Lemna minor); Chapter 7 bankruptcy July 2012; LEX/BLX-301 IP sold to Synthon B.V. May 2012; KR20080094914A promoter toolkit"
  - "Calicioglu et al. 2021, ACS Sustain Chem Eng — duckweed techno-economic floor ~$7.69/Mg dry biomass"
status: scope-page
---
...
If a duckweed-uricase construct were built, its native flavonoids might provide a second urate-relevant mechanism. This is option value, not demonstrated synergy; the first test is whether the native compounds reach a relevant dose. See [§Native-compound amplification or recombinant payload?](#native-compound-amplification-or-recombinant-payload).
...
2. **Cultivation elicitation** — luteolin/apigenin are UV-protective pigments; UV-B, nutrient stress, and light regime can upregulate flavonoid biosynthesis without genetic engineering. This may raise native-compound exposure, but it does not solve recombinant-uricase expression.
...
| DW-4 | Map duckweed onto [`modality-chokepoint-matrix.md`](./modality-chokepoint-matrix.md) (engineered-organism × mucosal/systemic rows) + [`delivery-route-matrix.md`](./delivery-route-matrix.md) (oral edible-biomass route) | $0 | <1 | Which gout compartments and payload classes an edible plant can realistically reach |
...
- [`chassis-pending-interventions.md`](./chassis-pending-interventions.md) — portfolio-level implementation and track comparison
- [`modality-chokepoint-matrix.md`](./modality-chokepoint-matrix.md) — exploration surface (engineered-organism rows)
- [`engineered-lbp-chassis.md`](./engineered-lbp-chassis.md) — another local-delivery chassis class
- [`uricase.md`](./uricase.md), [`crispr-uricase.md`](./crispr-uricase.md) — the lead payload and current engineering evidence
- [`tcm-modern-rigor-intersection.md`](./tcm-modern-rigor-intersection.md) — the multilingual / traditional-medicine rigor framing
