---
title: "Duckweed (Lemnaceae) — Aquatic-Sibling Chassis to Koji"
date: 2026-05-29
tags:
  - chassis-class
  - duckweed
...
| DW-4 | Map duckweed onto [`modality-chokepoint-matrix.md`](./modality-chokepoint-matrix.md) (engineered-organism × mucosal/systemic rows) + [`delivery-route-matrix.md`](./delivery-route-matrix.md) (oral edible-biomass route) | $0 | <1 | Where in the chokepoint map duckweed opens a door koji can't |
...
- [`chassis-pending-interventions.md`](./chassis-pending-interventions.md) — duckweed is logged there as a chassis-class entry
- [`modality-chokepoint-matrix.md`](./modality-chokepoint-matrix.md) — exploration surface (engineered-organism rows)
- [`engineered-lbp-chassis.md`](./engineered-lbp-chassis.md) — sibling peer-track scope page (different chassis class)
- [`engineered-koji-protocol.md`](./engineered-koji-protocol.md), [`aspergillus-oryzae.md`](./aspergillus-oryzae.md) — the priority chassis duckweed is compared against
- [`uricase.md`](./uricase.md), [`crispr-uricase.md`](./crispr-uricase.md) — the lead target + its current chassis benchmark
- [`tcm-modern-rigor-intersection.md`](./tcm-modern-rigor-intersection.md) — the multilingual / traditional-medicine rigor framing
- [`etc/open-enzyme-vision.md`](./etc/open-enzyme-vision.md), [`etc/open-source-platform.md`](./etc/open-source-platform.md) — mission + open-source positioning this chassis serves
