...
**The NLRP3 chokepoint is not fungal-empty; it was query-framing-empty.** Phase 3's "empty" verdict reflected the limitation of seeding from ChEMBL pure-compound activity columns rather than from species-name + traditional-pathology PubMed framing. The pattern observed across complement and NLRP3 makes query-frame diversity a required search control, not evidence about any candidate's rank. See the [2026-05-19 query-framing retrospective audit](../logs/lit-scan-query-framing-retrospective-audit-2026-05-19.md) for the broader audit and methodology fix.
