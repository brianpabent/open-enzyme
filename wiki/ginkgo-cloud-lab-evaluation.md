...
- **Decision (2026-05-13; rationale narrowed 2026-07-13): skip the $39 cell-free for now.** The assay can test translation/solubility in an *E. coli*-lysate-like environment, but it cannot resolve physiological luminal substrate, oxygen, transit, topology, peroxide, or fungal-host behavior. comp-019 is no longer evidence that those questions are already answered. Revisit only if cell-free ORF translation becomes the specific next gate.
...
**No action.** The $39 cell-free pre-gate answers a narrow translation/solubility question, not the physiological-regime failure exposed by comp-044. Use it only when ORF translation is the bottleneck; it is not a substitute for validation §1.33.
...
- [`ward-1995-lab-access.md`](../operations/ward-1995-lab-access.md) — the academic-collaboration wet-lab path; Ginkgo's $39 pre-gate sits *upstream* of this path, not in competition with it.
