...
**CP0 gap — honest acknowledgment.** The Open Enzyme stack has **no fermentable C5a / C5aR1 modulator**. Avacopan (Tavneos, oral C5aR1 antagonist, FDA-approved 2021 for ANCA vasculitis) is the pharma adjunct here — the CP0 chokepoint is covered by a small-molecule antagonist, not anything a GRAS yeast or koji can produce. This is a real gap and the vision does not paper over it. See [complement-c5a-gout.md](./complement-c5a-gout.md) for the full 770-line analysis.
