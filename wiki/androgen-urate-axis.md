...
- **Testosterone upregulates URAT1 mRNA, but not URAT1 protein in non-orchiectomized animals; Smct1 protein induction + GLUT9 attenuation are the supported protein-level drivers of testosterone-associated male hyperuricemia in mouse renal tissue.** Hosoyamada/Takiue 2010 (PMID 20589576) found that orchiectomy reduced URAT1 mRNA and protein and testosterone replacement restored both. In non-orchiectomized animals, however, testosterone enhanced Urat1 *mRNA* without changing Urat1 *protein*. Testosterone also enhanced Smct1 at mRNA and protein levels and attenuated GLUT9. Thus, “testosterone → URAT1” is an mRNA-level result at physiological-male baseline; the proximate protein-level renal mechanisms are Smct1 induction and GLUT9 attenuation. (Animal Model; rodent renal expression studies.)
- **Direct androgen suppression of intestinal ABCG2 is unsupported by the sources reviewed, while healthy-human baseline sex stratification remains unresolved.** [COMP-017](./intestinal-abcg2-sex-dimorphism-public-data-mining-computational.md) extracted no direct sex-stratified GTEx or HPA intestinal values. Slepnev et al. reported that nominal 1, 10, and 100 µM testosterone increased ABCG2 in Caco-2 cells, with PXR/FXR inhibitor effects that did not directly test or exclude androgen-receptor involvement (**In Vitro**). MacLean et al. reported no sex-specific difference in a healthy-rat intestinal scan (**Animal Model**). Hoque et al. found a sex-dependent urate phenotype in Q140K mice and a 78% jejunal versus 44% renal Western-blot reduction (**Animal Model**). Liu et al. found estradiol-benzoate-associated ABCG2 induction at nominal 100 µM in Caco-2 cells (**In Vitro**). These contexts do not establish a healthy-human male ceiling or a clomiphene mechanism.
- **Estradiol has a UA-lowering pattern overall** — Takiue 2011 (PMID 21360409) shows estradiol suppresses URAT1, GLUT9, and (counterintuitively for the urate-excretion framing) renal ABCG2 in mouse kidney. Liu et al. 2021 (PMC8212495) reported estradiol-associated intestinal ABCG2 induction via PI3K/Akt in its tested systems; COMP-017 retains the Caco-2 result at the nominal 100 µM **In Vitro** tier and does not infer physiological magnitude. Net human effect is urate-lowering (Mumford 2013 BioCycle PMID 23562957: every log-unit increase in E2 → −1.1% urate). (Animal Model + observational human correlation with menstrual-phase UA fluctuation.)
...
> **Portfolio implication:** Do not assign a hard male intestinal-ABCG2 ceiling or infer a healthy-human null. Genotype, hormone state, and inflammation remain prospective context variables. Candidate rescue mechanisms—including PI3K/Akt induction, PPARγ-mediated wild-type ABCG2 induction, and Q141K trafficking rescue—remain gated on direct apical-protein and urate-flux measurements.
...
- **The androgen-urate axis is a prospective response-stratification layer on top of transporter biology.** TRT / SERM / AAS / AI status and SHBG are reasonable variables to measure in research cohorts, but no validated model shows that they predict response to a gut-lumen uricase configuration.
...
- **Separate URAT1-expression leads require separate validation.** Carnosine and cordycepin have distinct animal-model expression signals, but neither result establishes direct human URAT1 transport, an androgen interaction, exposure feasibility, or interchangeability. The *Smilax glabra* record applies to a total-flavonoid fraction containing four astilbin stereoisomers; it does not establish astilbin-specific URAT1 causality. Test each exact material and route independently before making any redundancy or substitution claim.
...
The transporter evidence supports an androgen-sensitive renal urate-handling contribution to male gout risk. An intestinal ABCG2 contribution remains plausible, but neither loss of a female-positive signal in healthy men nor direct testosterone suppression has been established in healthy-human intestine.
...
The stack design is unchanged. The transporter-side question is whether hormone state produces a measurable intestinal ABCG2 or urate-flux difference at relevant exposure; [COMP-017](./intestinal-abcg2-sex-dimorphism-public-data-mining-computational.md) leaves the healthy-human baseline unresolved and does not establish either active androgen suppression or an absent female-positive signal.
