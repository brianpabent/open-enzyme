...
- **Intestinal ABCG2 is sex-dimorphic, but the supported mechanism is estradiol-positive on the female side, not testosterone-negative on the male side.** [comp-016](./t-abcg2-suppression-evidence-mining-computational.md) found no primary in-vivo evidence of direct androgen-driven intestinal ABCG2 suppression. Klyushova 2023 instead found that testosterone increased ABCG2 via PXR/FXR in Caco-2 cells, and MacLean 2008 found no baseline sex difference across four healthy-rat intestinal segments. Hoque 2020 (PMID 32488095) found 88% intestinal ABCG2 protein loss and severe hyperuricemia in male Q140K mice, while female Q140K mice were protected. Yu 2021 (PMID 34144706) showed estradiol-induced intestinal ABCG2 through PI3K/Akt, partially blocked by LY294002. The 88% magnitude and mechanistic details are based on an abstract-level comp-016 evidence review rather than full-text source verification, but the qualitative verdict is unchanged: males lack the female-positive estradiol drive; active androgen suppression remains unproven. (Animal Model + In Vitro for the estradiol-positive arm; Mechanistic Extrapolation for the male-asymptote framing.)
...
- **Net result:** androgens push the kidney toward an under-excreter phenotype; estrogens push toward an over-excreter phenotype through renal and intestinal mechanisms. The intestinal ABCG2 sex dimorphism is best framed as estradiol-positive on the female side, not testosterone-negative on the male side. The male-baseline intestinal ABCG2 asymptote therefore lacks the female-positive signal; active androgen capping of the gate is unproven.
...
- **Half-life:** clomiphene is a racemic mix of enclomiphene (short half-life ~5 hours, anti-estrogen at hypothalamus) and zuclomiphene (longer, ~24-hour-to-multi-day terminal phase in older PCOS pharmacokinetic studies). The commonly quoted 5–7-day zuclomiphene half-life lacks a line-anchored primary pharmacokinetic source here; PMID 19033451 supports slower apparent clearance without resolving that exact range. Chronic dosing accumulates zuclomiphene and produces relatively stable steady-state levels — **EOD dosing at the same per-dose amount gives nearly-identical steady-state exposure to daily dosing**, because the long half-life smooths the gaps.
...
- **Cross-track URAT1 redundancy.** The carnosine URAT1 lever in the koji track has *mechanistically equivalent* counterparts in the medicinal-mushroom and TCM tracks, providing platform-level redundancy that none of the tracks were designed for individually:
  ...
  **Caveat — koji's URAT1 coverage is *proposed*, not yet demonstrated.** Carnosine in the koji track is the *optional third cassette* per [koji-endgame-strain.md §2.5](./koji-endgame-strain.md), gated on §1.24's wet-lab feasibility test (target ≥500 mg/L titer). If §1.24 reports below threshold, koji's URAT1 coverage is not a current platform feature; it would require alternative carnosine-delivery routes (oral supplement, separate strain) or new cassette engineering. The mushroom-track (cordycepin) and TCM-track (astilbin) URAT1 coverage are independent of this contingency. **Engineering nuance:** carnosine's third-cassette feasibility is *titer-gated*, not chaperone-load-limited — carnosine biosynthesis is cytosolic (CarnS + panD, zero secretion-pathway burden, zero disulfides), so the chaperone-orthogonal stacking framework ([chaperone-orthogonal-stacking.md](./chaperone-orthogonal-stacking.md)) predicts lower shared folding burden for adding it to the dual-cassette uricase + lactoferrin multi-payload strain (predicted weighted synergy ≥0.85 per [koji-endgame-strain.md §407](./koji-endgame-strain.md), Huynh 2020 adalimumab-equivalent ER burden). The disulfide-load concern that gates triple-cassette stacking applies to **DAF SCR1-4 SCR1-4** (8 additional disulfides on PDI) routed to separate-strain per the §1.25 wet-lab gate, NOT to carnosine.
