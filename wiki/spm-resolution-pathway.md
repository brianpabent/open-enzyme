...
**Substrate-supply hypothesis for a gut-lumen uricase track (Speculative).** Lactoferrin suppresses TNFα in an animal model, and TNFα suppresses intestinal ABCG2 in vitro and in clinical biopsy material. Their composition might increase luminal urate available to uricase, but no combined experiment establishes that synergy. This is track-local, not Open Enzyme's primary urate-lowering mechanism. Test in validation §1.14.
