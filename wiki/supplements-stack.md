...
A practical, daily multi-compound stack targeting the NLRP3 inflammasome cascade at multiple points. Designed to suppress gout flare intensity, frequency, and duration while addressing the inflammatory root of the disease—not just the uric acid level.
...
**Practical consideration:** Short-term ketosis raises serum uric acid by 5–10% (competition for renal excretion). This is offset by BHB's direct NLRP3 suppression and will be eliminated once [[engineered-yeast-uricase]] is deployed to handle uric acid burden. (Source: nlrp3-exploit-map.md)
...
**Practical note:** Avoid fasting during active gout flares (can precipitate hyperuricemia worsening). Use between-flare periods for autophagy building. (Source: nlrp3-exploit-map.md)
...
**Dosing:** 200–500 mcg/day intranasal

**Administration:** 
- Morning spray (nasal mucosa, high PepT1 expression)
- Combine timing with BPC-157 spray for convenience

**Sourcing:** Research peptide suppliers (Peptides@BioTechPackage, GenScript custom peptide service); ~$100–200 for monthly supply
...
**Practical note:** Maintain current protocol; synergizes with KPV (both are small peptides, non-overlapping pathways). (Source: nlrp3-exploit-map.md, peptide-gout-addendum.md)
...
**Practical note:** The bioavailability trick is critical. Frozen or cooked sprouts without myrosinase won't work. (Source: nlrp3-exploit-map.md)
...
- Or direct EPA supplementation (prescription omacamtiv, or OTC concentrated EPA)
...
**Practical note:** Effect is modest (15–20% CRP reduction reported), but non-toxic and pleasant. Useful as addition to stack but not standalone therapy. (Source: gout-deep-dive.md)
...
**Dosing:** 600–1,200 mg/day (split AM + evening)

**Practical note:** Take on empty stomach for better absorption
...
**Dosing:** 250 mg once daily (standard for alcohol use disorder; off-label for gout)

**Key advantage:** FDA-approved for 70+ years, well-tolerated, ~$30/month
...
**Dosing:** TBD from Phase 2 animal studies; likely 10–20g dried yeast powder daily or equivalent live cells
...
**Dosing:** TBD; likely 10–20g koji per day (equivalent to ~1 cup koji rice)
...
- Omega-3 high-EPA (2g EPA+DHA) — with food
...
**Evening (with dinner):**
- Omega-3 high-EPA (2g EPA+DHA) — second dose
...
| **Engineered Koji** | *Validated Ph2* | Upstream + Digestive | Dual enzyme | *TBD 2026* |
...
- All compounds listed have low interaction profiles
- KPV + BPC-157 nasal: complementary, non-interacting
- Sulforaphane + Quercetin + Oridonin: all Nrf2 activators; safe to combine (cumulative effect)
- Omega-3 + NAC: synergistic antioxidant effect
- Disulfiram: check for alcohol interaction (use only if not drinking)

**Cautions:**
- NSAIDs + high-dose omega-3: slight bleeding risk (rare; monitor)
- Disulfiram: contraindicated if any alcohol use; requires liver function monitoring
- Intermittent fasting during active flares: may transiently raise uric acid; timing matters

**Medical oversight:**
- Discuss entire stack with primary care or rheumatologist
- Run baseline CMP (liver, kidney function) if considering disulfiram
- Annual vitamin D level check to adjust D3 dosing
- Monitor adherence and tolerability; adjust compounds as needed
...
- Add sulforaphane + quercetin (both are safe, rapid onset)
- Continue BPC-157 nasal spray (already using)
...
**Week 4+:**
- Introduce vitamin D3 + K2
- Consider fermented foods (natto 1–2×/week minimum)
- Schedule physician visit to discuss disulfiram/tranilast

**Ongoing:**
- Track serum uric acid monthly (initially), then every 3 months
- Monitor flare frequency/severity in journal
- Adjust stack based on response; some may tolerate all, others may drop 1–2 compounds if side effects

---

*This stack is a living document. Update as [[validation-experiments]] (Phase 2 & 3) generate new data. Individual compounds may be emphasized or de-emphasized based on personal tolerability and efficacy.*
