...
**ABCG2 induction via fermentable fiber (source: abcg2-modulators.md):** Fermentable fiber can increase colonic butyrate, and sodium butyrate restored intestinal ABCG2 expression in a hyperuricemic mouse model through the PPARγ axis. This supports wild-type ABCG2 induction. Direct rescue of Q141K trafficking by butyrate has not been demonstrated; Basseville 2012 used other pharmacologic rescue conditions. Do not present fiber or butyrate as a genotype-specific Q141K rescue recommendation without direct trafficking and urate-flux data.
