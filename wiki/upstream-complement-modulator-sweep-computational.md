...
The answer turns out to be: **a lot of compounds, anchored by rosmarinic acid** (the active compound in rosemary, lemon balm, and spearmint) which has been documented since 1988 to block the C3 convertase — the central enzyme of complement — at single-digit micromolar concentrations, with three independent in vivo studies showing it works in animals at modest doses. So Brian's "if the answer is rosemary, I'll grow rosemary" half-joke turned out to be load-bearing: rosmarinic acid is the most well-characterized natural-product upstream complement modulator in the literature, and rosemary is FDA GRAS, dietary, gram-scale dosable, and grown in any backyard garden.
