---
id: H10
title: "Clomiphene exposure and serum urate are positively coupled in a susceptible high-androgen phenotype"
...
related:
  ...
  - ./H07-clomid-intestinal-er-antagonism.md
  - ./README.md
sources:
  ...
  - "PMID 3918542 — clomiphene stimulation in participants with pre-existing gout; not evidence of incident gout or a clomiphene urate effect."
  - "PMIDs 32233208, 34933414, 31216250, and 22458540 — male clomiphene safety studies/review that did not measure serum urate or incident gout as a prespecified endpoint."
...
1. Collect two same-laboratory venous panels 7–14 days apart before a clinically directed exposure change and two panels 7–14 days apart after the new exposure state is stable. Each panel includes serum urate, total testosterone, sensitive estradiol, SHBG, creatinine or cystatin C, and paired urine urate/creatinine.
2. Repeat each steady-state venous urate measurement so that any change can be judged against analytical and within-person variability. Calibrate a home meter with paired venous/capillary samples if capillary trends are used between visits.
3. Separate renal handling with fractional excretion of urate. A urate change with concordant FEUA change supports renal involvement; unchanged FEUA leaves production and intestinal disposal open.
4. Test the population claim in a prospective clomiphene cohort with baseline and follow-up urate, hormones, renal function, flare history, and major dietary or medication confounders prespecified.
5. Test intestinal ER or stereoisomer mechanisms only in direct enterocyte experiments with clomiphene, enclomiphene, and zuclomiphene at exposure-relevant concentrations.
