...
4. **Topology uncertainty:** comp-045 generates a blocked candidate layout for measuring urate, product, oxygen, peroxide, viability, and UOX/support-module qualification together. Its three run slots are provisional, not powered. It contains no biological measurements and does not evaluate or rank a topology.
