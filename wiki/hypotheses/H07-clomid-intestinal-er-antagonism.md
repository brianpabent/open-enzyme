...
3. **The Clomid → high UA observation in gout-prone men is explained by sub-claim 2 blocking sub-claim 1, NOT by AR-mediated transcriptional repression of intestinal ABCG2.** Per comp-016, direct primary evidence for "T suppresses intestinal ABCG2 via AR" is WEAK / UNCONFIRMED — zero in vivo studies show castration → intestinal ABCG2 ↑, and Klyushova 2023 actively contradicts (T INDUCES ABCG2 in Caco-2). The renal URAT1 arm of T → high UA partially survives verification (Hosoyamada 2010), but accounts for only some fraction of the total UA effect. The intestinal-arm contribution to the Clomid-UA-elevation is more parsimoniously explained by the ER-antagonism mechanism than by a contradicted AR-suppression mechanism.
