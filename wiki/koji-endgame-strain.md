...
related:
  ...
  - lactoferrin.md
  - uricase.md
  - uricase-only-koji-expression-spec.md
...
**comp-022 v2 gene-synthesis-time refinements (2026-05-14):** The ClockBase-style combinatorial ranking of 43,200 uricase cassette candidates ([uricase-cassette-ranking-computational.md](./uricase-cassette-ranking-computational.md)) confirmed the §1.9 architecture and added three zero-marginal-cost refinements to the uricase cassette design. All three should be incorporated into the §1.9 gene-synthesis order:
