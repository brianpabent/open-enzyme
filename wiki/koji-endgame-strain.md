...
- SDS-PAGE to look for truncated / incompletely-processed lactoferrin species (KEX-2 capacity bottleneck would manifest as a fusion-size band).
...
1. **Can the Ward 1995 glucoamylase-KEX2 architecture be verified for dual uricase + lactoferrin expression in *A. oryzae*?** The §3 feasibility test. Gates everything else. 8–12 weeks, $3–5k.
