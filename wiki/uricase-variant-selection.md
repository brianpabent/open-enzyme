...
**ALLN-346 mutant now analyzed as a second sequence (2026-07-14, comp-review audit action):** comp-011 originally analyzed only wild-type P78609 while recommending the **P78609 + ALLN-346** construct — a gap the independent comp review flagged, because the ALLN-346 mutation **I132R** lands on the P1′ residue of the position-130 KR site (`KRI`→`KRR`). The mutant has now been added to comp-011 as a second analyzed sequence (all 7 mutation positions grep-verified against `P78609.fasta`). Result: **I132R softens the position-130 KEX2 site from HIGH to MODERATE** (P1′ I→R, a reduced-efficiency residue); position-138 stays HIGH and no new KR sites appear. This does **not** change the overall MODERATE dual-cassette verdict (codon burden and free-Cys risk are unchanged, and the uricase KR sites are non-load-bearing under direct secretion), but it refines the fusion-topology contingency in point 3: under a glucoamylase-KEX2 fusion, the wild-type "mutate both 130 + 138" plan becomes "138 still needs KR→KQ; 130 is already reduced by I132R." *(Mechanistic Extrapolation; in silico.)*
