...
- **Theaflavins (TF1/TF2A/TF2B/TF3, black-tea polyphenols):** Disrupt the **NLRP3-NEK7 interaction** downstream of mitochondrial ROS suppression — a distinct mechanism from EGCG's proteasome-mediated CP1a route. Chen 2023 *Acta Pharmacol Sin* (PMID 37221235): 50–200 μM theaflavin dose-dependently inhibited NLRP3 inflammasome activation in LPS-primed macrophages stimulated with ATP, nigericin, or **MSU crystals** (In Vitro); suppressed ASC speck formation, caspase-1 p10 cleavage, GSDMD-NT pyroptosis, and IL-1β release. Oral theaflavin significantly attenuated **MSU-induced mouse peritonitis** (Animal Model). TF3 sub-fraction also covers CP1a via TNFSF14/HVEM modulation (Hosokawa 2010 PMID 20461739). Unique to theaflavins in the OE stack: simultaneous ↓URAT1, ↓GLUT9 (renal urate reabsorption block) and ↑OAT1/OCTN1/OAT2 (secretion enhancement). Tier 2 supplement candidate. See [theaflavins.md](./theaflavins.md) for the full dossier. (In Vitro + Animal Model; source: theaflavins.md)
...
- **Anakinra (Kineret)**: Recombinant IL-1 receptor antagonist (IL-1Ra). Competitive antagonist at IL-1R1 that blocks both IL-1β and IL-1α from binding. Single injection can abort a flare within hours. FDA-approved for RA and CAPS, used off-label for gout. Limitation: 100 mg daily subcutaneous injection, short half-life (~4–6 hours), expensive without insurance. Demonstrates that blocking IL-1 signaling is sufficient to stop a gout flare. (Source: nlrp3-exploit-map.md)
  ...
  **Acute-flare protocol (added 2026-05-19, source: gout-action-guide.md):** **100 mg SC daily × 3 days, self-administered in thigh/abdomen** (NOT intra-articular). Single injection can abort a flare within hours; the 3-day regimen handles the full flare window. **Cost: ~$300/dose × 3 = ~$900/flare** at retail (insurance-variable; cost is the practical access gate, not prescriber willingness). **Access: rheumatologist off-label** — finding a prescriber for an off-label indication is solved by cost-of-care budget; the gate is the patient's willingness to pay $900/flare without insurance coverage.

  **The cumulative-burden framing (load-bearing for recurrent-flare patients):** if a patient flares 3–6× per year over 30 years, prednisone's cumulative steroid burden (bone loss, cataracts, adrenal suppression, glucose intolerance, mood/sleep/BP effects) compounds substantially. Anakinra has **minimal known cumulative burden** — it's recombinant endogenous IL-1Ra (the body's own protein), no bone/glucose/adrenal effects; long-term concern is only infection masking under chronic use (not relevant for 3-day acute use × few flares/year). For recurrent-flare patients with significant lifetime steroid burden, anakinra is the cleanest acute-flare-abort option *clinically available today*.

  **Strategic position within the platform:** anakinra is the **near-term bridge** while the [inhaled mRNA-IL-1RA pulse](./chassis-pending-interventions.md) (per [chassis-pending-interventions.md §4](./chassis-pending-interventions.md), [comp-033](./computational-experiments.md) + [comp-036](./computational-experiments.md)) develops on a 5–10 year horizon. Same mechanism (IL-1R1 competitive antagonism), same chokepoint (CP5a), different delivery route. The inhaled-mRNA route changes the economics (50–3,000× cheaper per flare than canakinumab) and the access path (self-administered pulmonary vs SC injection) but the underlying receptor-blockade biology is identical. Anakinra SC fills the gap between "today's prednisone-burden patient experience" and "tomorrow's inhaled mRNA-IL-1RA." See [gout-action-guide.md §"Active flare"](./gout-action-guide.md) for the acute-flare-abort comparator table.

  **Endogenous IL-1Ra biology — anakinra is recombinant human IL-1Ra, not a foreign molecule.** Humans naturally produce IL-1Ra (~17 kDa, encoded by IL1RN, secreted primarily by macrophages and neutrophils as feedback brake on IL-1 signaling). Endogenous IL-1Ra competes with IL-1α and IL-1β for the same IL-1R1 receptor — when bound, it occupies the receptor without triggering downstream signaling. The IL-1β / IL-1Ra ratio determines net signaling: at homeostatic baseline, endogenous IL-1Ra is in ~100× molar excess over IL-1β, keeping signaling damped. Inflammatory states (gout flare, autoimmune, sepsis) tip the ratio by driving IL-1β production faster than IL-1Ra production, exceeding the endogenous brake. **Therapeutic anakinra is the same protein the body makes, just at supplemental dose** — that's why the safety profile is so clean (essentially zero immunogenicity, no ADCC/CDC off-target effects, simple competitive-antagonism mechanism). The "endogenous brake" framing is also why mRNA-encoded IL-1Ra (per [`chassis-pending-interventions.md` §4](./chassis-pending-interventions.md)) is a cleaner payload choice than mRNA-encoded anti-IL-1β monoclonal antibody — IL-1Ra is small (no glycosylation, no disulfides, no heavy/light chain assembly), broader-mechanism (blocks IL-1α AND IL-1β at the same receptor), and immunogenicity-free as a recombinant version of an endogenous protein.
...
- **Inhaled mRNA-IL-1RA pulse (chassis-pending, pulmonary delivery)**: Lipid-nanoparticle-formulated mRNA encoding IL-1 receptor antagonist, delivered via vibrating-mesh nebulizer (POC) or dry-powder inhaler (eventual product). Transient pulmonary epithelial expression of IL-1Ra over the 12–72-hour flare window matches the natural timeline of an acute gout flare. Mechanistically identical to anakinra at the receptor level — competitive IL-1R1 antagonism — but reframes the delivery: pulmonary self-administration replaces daily SC injection. Pulmonary mRNA-LNP delivery is mature research-grade in CF and RSV programs; OE's contribution is target validation + dose modeling + partner identification (not manufacturing). **PK/PD reframe (added 2026-05-19, comp-036 walkthrough):** [comp-033](./computational-experiments.md) (single-dose) was RED at 2% of anakinra Cmax, but [comp-036](./computational-experiments.md) (repeat-dose PK/PD) is YELLOW — BID × 4–28 doses reaches **median 50–56% of the 0–72 h flare window above 80% receptor occupancy**. The right clinical comparison is NOT "matches anakinra Cmax" (no) but **"meaningfully better than prednisone over decades of recurrent flares?"** — Prednisone delivers full symptom suppression with cumulative steroid burden (bone loss, cataracts, adrenal suppression, glucose intolerance) compounding across 3–6 flares/year × 30 years; inhaled mRNA delivers partial occupancy with negligible cumulative burden (chronic LNP exposure lifetime is the open safety question). Cost edge per flare: **$2–120/flare** (comp-033) or **$10–600/flare** (comp-036) vs canakinumab **$18,000–23,000/flare** → **50–3,000× cost edge per flare**. Detailed entry at [`chassis-pending-interventions.md` §4](./chassis-pending-interventions.md); platform-positioning context at [`open-enzyme-vision.md` §10 "Chronic prevention + pulsatile flare-abort"](./etc/open-enzyme-vision.md); comparator table at [`gout-action-guide.md` §"Active flare"](./gout-action-guide.md). Acute-flare-abort track, complementary to chronic urate-lowering rather than competitive with it.
...
- **Lactoferrin** (indirect ALX/FPR2 modulator; Year 2-3 platform target): Fermentable at 3.5 g/L in *P. pastoris* and >2 g/L in *A. awamori* (Ward 1995, PMID 9634791); upgraded from Year 5+ to Year 2-3 target after Aspergillus expression precedent confirmed. Candidate for koji co-expression via Ward 1995 glucoamylase-KEX2 architecture — see [engineered-koji-protocol.md §16](./engineered-koji-protocol.md). Indirect SPM agonism mechanism; also suppresses TNFα-driven ABCG2 suppression (Ferrer-Picón 2020, PMID 31211831), adding a gut-lumen-sink benefit beyond CP5b. (In Vitro + Animal Model; source: spm-resolution-pathway.md, engineered-koji-protocol.md)
...
- **Zileuton** (pharmaceutical 5-LOX inhibitor, off-label): FDA-approved for asthma (Zyflo / Zyflo CR, 1,200 mg BID). Directly inhibits 5-LOX, blocking LTB4 synthesis. Zero gout-specific trials registered on ClinicalTrials.gov as of 2026-05-05 — a complete pipeline gap, not a buried negative result. Hepatotoxicity monitoring required (boxed warning; monthly LFTs × 3 months). Mechanistic case is strong given the LTB4/neutrophil axis in gout. See [zileuton.md](./zileuton.md) for the full dossier including expected outcomes, side-effect comparison, and n=1 protocol design. (Clinical Trial for asthma; Mechanistic Extrapolation for gout; source: zileuton.md)
