...
- **Data-quality gap for gout-relevant variants (added 2026-05-17, source: gout-action-guide.md):** Consumer SNP arrays (23andMe, AncestryDNA, etc.) have uneven raw SNP data quality for the specific variants gout stack design depends on (ABCG2 Q141K rs2231142, SLC2A9 GLUT9 variants, SLC22A12 URAT1 variants, HLA-B*58:01 typing). These chips are optimized for common-variant genome-wide imputation, not for the specific pharmacogenetic loci where a miscall changes a clinical decision. A clinical-grade CLIA PCR or WGS is the right tool for gout-relevant variant typing. Consumer panels are adequate for ancestry and broad trait exploration, not for the precision pharmacogenomics that genotype-stratified stack design requires. (source: gout-action-guide.md)
