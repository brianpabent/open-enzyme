...
1. **Q141K × fiber differential response.** Predicted but untested: Q141K-positive gout patients should show larger UA reduction with fermentable fiber than wild-type-positive patients, because butyrate hits both PPARγ-induction and HDI-rescue. A pharmacogenomic-stratified RCT (n ~120, baseline UA ≥7 mg/dL, stratified Q141K hetero/wild-type, 12-week inulin or equivalent) would resolve this. Estimated cost: $150K, 6 months. High platform-relevance.
