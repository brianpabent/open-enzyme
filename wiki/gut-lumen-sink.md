...
If transporter supply proves rate-limiting, WT-ABCG2 induction and Q141K rescue become separate experimental branches. Direct butyrate rescue and small-molecule chaperone candidates are both unvalidated; neither is currently a load-bearing platform feature.

**Shared wet-lab gate:** [`validation-experiments.md` §1.14](./validation-experiments.md) tests WT induction and Q141K trafficking/urate flux in parallel. It determines whether any direct-butyrate Q141K effect exists; it does not begin from an assumed rescue adjunct.
