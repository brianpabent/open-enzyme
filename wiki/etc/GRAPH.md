...
graph TB
    ...
    DE17 -->|"SUPERSEDED by comp-044; ΔSUA, genotype ordering, and saturation regime retired"| G1
    ...
    DE22 -->|"historical comp-019 dependency; quantitative band retired by comp-044"| DE17
    ...
    DE24 -->|"carbon fate unresolved; test PPARγ/ABCG2 only after isotope-resolved butyrate"| AM4
    ...
    DE26 -->|"α-coefficient CORROBORATED: ESM2 pLDDT 100% above 80, range 87.6-89.8"| CH11
