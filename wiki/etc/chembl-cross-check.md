...
| 8 | **Ursolic acid** | CHEMBL169 | **ROR-γ: IC50 = 0.75 nM** (pChEMBL 9.12, *J Med Chem* 2023); **NF-κB (p65): IC50 = 31 nM** (pChEMBL 7.51, *Bioorg Med Chem* 2018); **SENP1: IC50 = 6.4 nM** (pChEMBL 8.19, *Eur J Med Chem* 2022); HIV-1 EC50 = 10 nM; 16 total entries pChEMBL ≥ 6 | NLRP3/NF-κB suppressor (triterpene), OA + Kawasaki animal models | **YES (major)** — ChEMBL v37 contains 16 entries at pChEMBL ≥ 6. NF-κB at 31 nM directly supports the NF-κB framing with biochemical data. ROR-γ at 0.75 nM is a curated biochemical hit, but direct tophus evidence does not establish Th17/IL-17 as a causal driver; ROR-γ activity is therefore not a current priority (see [open-questions.md](../open-questions.md)). | 2026-07-01 |
...
**Gout hypothesis:** Ursolic acid is evaluated as an NLRP3/NF-κB suppressor with supporting OA and Kawasaki **Animal Model** evidence. Its production precedent affects sourcing feasibility, not gout efficacy.

**Role of ROR-γ in gout prioritization:** ROR-γ (RAR-related orphan receptor gamma; encoded by RORC) is the master transcription factor for Th17 cell differentiation and IL-17A/F production. Single-cell and spatial analysis of tophus tissue instead identified a tophus-exclusive SPP1/MMP9 macrophage population associated with matrix remodeling and bone erosion, while intra-tophus CD4 T cells skewed regulatory (PMID 41107120). This does not establish Th17/IL-17 as a causal driver of tophus biology. The ROR-γ IC50 remains a valid **In Vitro** biochemical datum, but it does not establish gout-specific therapeutic relevance; see [open-questions.md](../open-questions.md) §"Chronic tophaceous gout — the adaptive-immune axis."

**NF-κB evidence:** A curated NF-κB (p65) IC50 = 31 nM (*Bioorg Med Chem* 2018) provides **In Vitro** biochemical evidence for NF-κB inhibition. It does not establish gout-specific efficacy.

**SENP1 mechanism:** SENP1 (sentrin-specific protease 1) is the de-SUMOylation enzyme responsible for processing SUMO precursors and for maturation of SUMO-modified proteins. SENP1 has been linked to NF-κB pathway regulation (IKKβ SUMOylation is a negative regulatory modification; SENP1 activity frees IKKβ to activate NF-κB). SENP1 inhibition → sustained SUMOylation → attenuated IKKβ → NF-κB suppression is a **Mechanistic Extrapolation** for gout.

**Current interpretation:** NF-κB at 31 nM and SENP1 at 6.4 nM are useful **In Vitro** biochemical anchors for the NF-κB mechanism claim. The ROR-γ result establishes target activity but does not currently justify a gout-specific Th17 track.

**Caveat:** The ROR-γ, NF-κB, and SENP1 assays test distinct targets; they are not independent replications of one mechanism. All are **In Vitro**, and neither the ROR-γ nor SENP1 route has gout-specific validation.
...
1. **Ursolic acid: the gout-relevant signal is NF-κB, not ROR-γ.** ROR-γ at 0.75 nM and NF-κB at 31 nM are **In Vitro** biochemical evidence of target activity. The NF-κB result supports the inflammatory-mechanism thesis; the ROR-γ result does not establish Th17/IL-17 as a causal driver of tophus biology and is not a current priority.
