...
| 8 | **Ursolic acid** | CHEMBL169 | **ROR-γ: IC50 = 0.75 nM** (pChEMBL 9.12, *J Med Chem* 2023); **NF-κB (p65): IC50 = 31 nM** (pChEMBL 7.51, *Bioorg Med Chem* 2018); **SENP1: IC50 = 6.4 nM** (pChEMBL 8.19, *Eur J Med Chem* 2022); HIV-1 EC50 = 10 nM; 16 total entries pChEMBL ≥ 6 | NLRP3/NF-κB suppressor (triterpene), OA + Kawasaki animal models | **YES (major, new 2026-07-01)** — baseline (v34) reported zero curated activities pChEMBL ≥ 6; ChEMBL v37 now has 16 entries. NF-κB at 31 nM directly supports wiki's NF-κB framing with biochemical data. ROR-γ at 0.75 nM is a curated biochemical hit, but a 2026-07-13 chronic-tophus scoping scan found Th17/IL-17 is a bystander, not a driver of tophus biology; ROR-γ activity is a curiosity, not a priority (see [open-questions.md](../open-questions.md)). | 2026-07-01 |
...
**Why ROR-γ matters for gout biology:** ROR-γ (RAR-related orphan receptor gamma; encoded by RORC) is the master transcription factor for Th17 cell differentiation and IL-17A/F production. **However, a 2026-07-13 chronic-tophus scoping scan found that Th17/IL-17 is a bystander, not a driver, of tophus biology** — the destructive work is done by an SPP1/MMP9 macrophage subset (innate-stromal), and zero IL-17-blocker gout trials exist. ROR-γ activity is therefore a curiosity rather than a priority for Open Enzyme; see [open-questions.md](../open-questions.md) §"Chronic tophaceous gout — the adaptive-immune axis." The ROR-γ IC50 remains a valid curated biochemical datum; it does not establish therapeutic relevance.
...
**Suggested action:** The `nlrp3-inhibitor-screen.md` already reflects the ChEMBL v37 findings and the scoping-scan Th17 bystander conclusion. No further propagation needed. NF-κB at 31 nM and SENP1 at 6.4 nM are independently useful biochemical anchoring points for the NF-κB mechanism claim.
...
1. **Ursolic acid: new biochemical target profile warrants mechanism update (corrected).** ROR-γ at 0.75 nM and NF-κB at 31 nM are direct-binding biochemical evidence for mechanisms the wiki claimed only on functional/animal grounds. However, a 2026-07-13 scoping scan found Th17/IL-17 is a bystander, not a driver of tophus biology; ROR-γ is a curiosity, not a priority. NF-κB at 31 nM remains a useful biochemical anchoring point. The `nlrp3-inhibitor-screen.md` already reflects both findings.
