...
Frozen docking run date: 2026-07-14. Attempted 135; 134 complete docking-score rows; incomplete: cyclosporine_a.
...
|---|---|---|---|---|---|---|---|
| novobiocin | -6.36 | -6.61 | -0.25 | 7/134 | record present | yes | no |
| elacridar | -6.30 | -8.23 | -1.94 | 8/134 | record present | yes | no |
...
|---|---|---|---|---|---|
| rosuvastatin | uncertain | no bounded record | yes | yes | no |
| vorinostat | uncertain | no bounded record | no | no | uncertain |
