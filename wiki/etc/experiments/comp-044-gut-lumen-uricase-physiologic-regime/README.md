...
- [`wiki/cordycepin-cassette-burden-computational.md`](../../../cordycepin-cassette-burden-computational.md) — treat COMP-023 as invalidated; retain only Jeennor's independent production evidence and the explicitly untested ER-orthogonality conjecture.
