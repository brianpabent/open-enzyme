...
[compounding-pharmacy track](../../../compounding-pharmacy-track.md)'s 503A
disulfiram pathway has a defensible dosing protocol.**

This is comp-027 in the [Open Enzyme computational experiments
registry](../../../computational-experiments.md).

**Interpretive wiki page:**
[`wiki/disulfiram-dose-modeling-computational.md`](../../../disulfiram-dose-modeling-computational.md)
...
[compounding-pharmacy-track.md §Pharmacy partner identification](../../../compounding-pharmacy-track.md)):
