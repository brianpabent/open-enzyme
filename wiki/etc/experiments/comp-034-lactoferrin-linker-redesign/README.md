...
- [`validation-experiments.md §1.10`](../../../validation-experiments.md) — lactoferrin
...
- [`bio-ai-tools.md §BioDesignBench`](../../../etc/bio-ai-tools.md) — first concrete use
...
Per [`wiki/etc/autonomous-screening-methodology.md` §"BioDesignBench evaluation-depth audit"](../../../etc/autonomous-screening-methodology.md):
