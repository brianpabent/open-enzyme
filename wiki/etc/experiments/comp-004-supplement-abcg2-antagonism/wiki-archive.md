...
**Reproducible artifact:** [`experiments/comp-004-supplement-abcg2-antagonism/`](../comp-004-supplement-abcg2-antagonism/) — script, inputs, and full outputs committed to the repo.
...
- [`experiments/comp-004-supplement-abcg2-antagonism/`](../comp-004-supplement-abcg2-antagonism/) — reproducible artifact
