...
- [experiments/comp-011-c-utilis-uricase-cassette-compatibility/](../comp-011-c-utilis-uricase-cassette-compatibility/) — Analysis code, inputs, outputs (machine-readable JSON + human-readable summary)
...
- [experiments/comp-001-uricase-shio-koji-protease-stability/](../comp-001-uricase-shio-koji-protease-stability/) — *A. flavus* uricase protease stability (comp-001, LOW)
- [experiments/comp-005-lactoferrin-shio-koji-protease-stability/](../comp-005-lactoferrin-shio-koji-protease-stability/) — Lactoferrin protease stability (comp-005, MODERATE)
