...
**Reproducible artifact:** [`experiments/comp-001-uricase-shio-koji-protease-stability/`](../comp-001-uricase-shio-koji-protease-stability/) — script, inputs, and full outputs committed to the repo.
...
Full methodology and limitations in [`experiments/comp-001-uricase-shio-koji-protease-stability/analyze.py`](../comp-001-uricase-shio-koji-protease-stability/analyze.py).
