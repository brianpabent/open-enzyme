...
- [`experiments/comp-015-t-axis-adjuvant-urate-mapping/`](../comp-015-t-axis-adjuvant-urate-mapping/) — the reproducible artifact (analyze.py, inputs/, outputs/, provenance.md).
