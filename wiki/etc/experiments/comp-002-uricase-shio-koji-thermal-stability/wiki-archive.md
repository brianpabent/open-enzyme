...
**Reproducible artifact:** [`experiments/comp-002-uricase-shio-koji-thermal-stability/`](../comp-002-uricase-shio-koji-thermal-stability/) — script, inputs, and full outputs committed to the repo.
