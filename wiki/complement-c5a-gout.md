...
>
> **Engineered-regulator status:** [comp-012](./daf-cd55-scr14-truncated-computational.md) classifies truncated DAF SCR1-4 (aa 35–285) as LOW protease risk in silico. That does not close CP0: expression, eight-disulfide folding, retained regulatory activity, and access to the relevant complement compartment require wet-lab validation under [§1.25](./validation-experiments.md). Single-cassette or alternative-chassis routing remains conditional on those results.
>
...
**The dietary-CP0 stratification prediction (untested):** the comp-018 / comp-020 candidates may bypass the CFH-regulation axis upstream. This is an untested stratification hypothesis; the formerly cited Q141K × butyrate analogy is itself unconfirmed and is not supporting evidence.
