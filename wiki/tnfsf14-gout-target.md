...
- Update [nlrp3-exploit-map.md](./nlrp3-exploit-map.md), [nlrp3-inflammasome.md](./nlrp3-inflammasome.md), [gout-pathophysiology.md](./gout-pathophysiology.md), [supplements-stack.md](./supplements-stack.md) (EGCG/omega-3 CP1b annotation). The [`etc/GRAPH.md`](./etc/GRAPH.md) is **archived, no longer maintained** (2026-05-29) — new concept nodes are not being added.
