...
- Update [nlrp3-exploit-map.md](./nlrp3-exploit-map.md), [nlrp3-inflammasome.md](./nlrp3-inflammasome.md), [gout-pathophysiology.md](./gout-pathophysiology.md), [supplements-stack.md](./supplements-stack.md) (EGCG/omega-3 CP1b annotation), and [GRAPH.md](./etc/GRAPH.md) (new TNFSF14 → HVEM/LTβR → NF-κB → priming edges).
