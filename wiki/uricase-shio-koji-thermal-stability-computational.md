...
> **Frozen long-form analysis** — method details, limitations (10+ items), failure-mode ranking, multilingual literature audit, comparison to comp-001: [`../experiments/comp-002-uricase-shio-koji-thermal-stability/wiki-archive.md`](../experiments/comp-002-uricase-shio-koji-thermal-stability/wiki-archive.md). Reproducible artifact: [`../experiments/comp-002-uricase-shio-koji-thermal-stability/`](../experiments/comp-002-uricase-shio-koji-thermal-stability/).
