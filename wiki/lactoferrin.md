...
- **PyRosetta-backed scoring** — ✅ **unblocked 2026-05-29** (UW academic Rosetta/PyRosetta license update; `pyrosetta 2026.3` installed credential-free, non-commercial). First use: the comp-034 Cartesian ΔΔG + structure-gated cleavage leg (see ★ note below).
