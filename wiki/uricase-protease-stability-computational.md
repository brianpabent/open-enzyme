...
Related: [COMP-001 artifact](./etc/experiments/comp-001-uricase-shio-koji-protease-stability/) · [computational experiment registry](./computational-experiments.md) · [thermal-stability proxy](./uricase-shio-koji-thermal-stability-computational.md) · [engineered koji protocol](./engineered-koji-protocol.md)
