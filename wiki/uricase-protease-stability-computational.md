...
# Uricase Protease Stability in Shio-Koji — Computational Analysis (comp-001)

> **Frozen analysis archived to [`../experiments/comp-001-uricase-shio-koji-protease-stability/wiki-archive.md`](../experiments/comp-001-uricase-shio-koji-protease-stability/wiki-archive.md)** (121 lines).
...
> at `experiments/comp-001-uricase-shio-koji-protease-stability/`.
...
- Full archived analysis: [`../experiments/comp-001-uricase-shio-koji-protease-stability/wiki-archive.md`](../experiments/comp-001-uricase-shio-koji-protease-stability/wiki-archive.md)
- Experiment directory (inputs, scripts, outputs): [`../experiments/comp-001-uricase-shio-koji-protease-stability/`](../experiments/comp-001-uricase-shio-koji-protease-stability/)
