...
- **Microbiome-derived butyrate / SCFA quantification.** [`tier-2-butyrate-assay-audit-computational.md`](./tier-2-butyrate-assay-audit-computational.md) (comp-038) found no ready-to-adopt home/colorimetric butyrate Tier 2 assay. Current path: GC-MS remains the Tier 3 anchor; HPLC-UV is a plausible Tier 2-lab candidate for culture supernatants after spike-recovery + GC-MS validation; electrochemical fecal SCFA profiling is a promising stool-specific future direction, not production-ready.
  ...
  **Structural gap — extends beyond butyrate to all microbiome-derived metabolites (added 2026-05-21; promoted to named Platform / Strategic Open Question 2026-05-22).** The Tier 2 absence is not a butyrate-specific inconvenience; it is a class-level methodology bottleneck for every intervention whose active molecule is produced *in situ* by gut bacteria. The same dose-verification problem applies to: **other SCFAs** (propionate, acetate — same GC-MS Tier 3 path, same Tier 2 absence); **secondary bile acids** (lithocholic acid, deoxycholic acid — Tier 3 is LC-MS/MS, no validated Tier 2 colorimetric or enzymatic surface); **microbial indoles** (indole-3-propionate, indole-3-aldehyde, AhR ligand class — Tier 3 is LC-MS/MS, Tier 2 absent); **TMAO** (Tier 3 LC-MS/MS, Tier 2 absent). The personalised-medicine pipeline can verify the *precursor* was administered (fiber, resistant starch, probiotic strain, dietary tryptophan), but cannot verify that the downstream metabolite reached the target tissue at the intended concentration — the dose remains an unverified variable, indistinguishable from mechanism-failure noise. Closing this gap for even *one* metabolite class with a validated Tier 2 proxy unlocks the QC loop for every future microbiome-metabolite intervention. comp-038's "Next Step" — full-text/protocol verification on PMID 23542733 and PMID 42041444 (**both completed 2026-07-14**: De Baere HPLC-UV confirmed for culture supernatant; Gu 2026 electrochemical-ANN confirmed GC-MS-validated for stool, n=30) + paired sodium-butyrate spike/recovery against GC-MS (the remaining wet-lab gate, [§1.31](./validation-experiments.md)) — is the cheapest path to that proof-of-concept for the SCFA sub-class; analogous desk audits + paired-validation designs would be needed per other metabolite class. **See [`open-questions.md` §"Class-level Tier 2 assay gap for microbiome-derived metabolites"](./open-questions.md) (Platform / Strategic section)** — this closing-note paragraph has been promoted to a named platform open question with Phase 2 follow-ups (P2-1 comp-038 next-step protocol-verification, P2-2 multi-operator round-robin when a Tier 2 candidate exists, P2-3 secondary-bile-acid extension).
