...
#### Step 1: Prepare Spore Suspension
    ...
    Count spores with hemocytometer. Target: 1 × 107 spores/mL
...
#### Step 2: Grow Mycelium
    ...
    Inoculate 1 × 107 spores into 100 mL liquid DPY medium (2% dextrin, 1% polypeptone, 0.5% yeast extract, 0.5% KH2PO4, 0.05% MgSO4·7H2O)
...
#### Step 3: Protoplasting (Cell Wall Removal)
    ...
    Resuspend washed mycelium in protoplasting solution:**— 10 mg/mL Yatalase** (Takara Bio, specifically for Aspergillus) *or* Lysing Enzymes from *Trichoderma harzianum* (Sigma L1412)**— in 0.8 M NaCl as osmotic stabilizer
    ...
    Resuspend in STC at 1 × 108 protoplasts/mL. Keep on ice.
...
#### Step 4: DNA Uptake
    ...
    — 100 μL protoplast suspension (~107 protoplasts)
...
| Dried & powdered koji | Dehydrate fresh koji at  Top Picks
