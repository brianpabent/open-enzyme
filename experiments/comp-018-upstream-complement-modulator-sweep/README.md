...
**Interpretive wiki page:** [`wiki/upstream-complement-modulator-sweep-computational.md`](../../wiki/upstream-complement-modulator-sweep-computational.md)

**Tracking index:** [`wiki/computational-experiments.md`](../../wiki/computational-experiments.md) — comp-018 row added.
