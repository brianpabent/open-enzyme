...
| Standardized TCM extract sourcing (Smilax glabra, Si Miao San components, etc.) — Chinese suppliers | [`tcm-modern-rigor-intersection.md`](../wiki/tcm-modern-rigor-intersection.md) | When primary-source qualification identifies one exact material worth sourcing; COMP-049 is Gate-1-approved but unrun and cannot rank materials |
