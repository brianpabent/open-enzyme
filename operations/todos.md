...
- **[2026-05-05] Authenticated patent-landscape review for *A. oryzae* dual-cassette work.** Earlier unauthenticated searching raised unpublished industrial work as a question but supplied no defensible probability, novelty conclusion, or freedom-to-operate result. Run a jurisdiction-aware review with authenticated patent databases and qualified legal interpretation only if the architecture becomes decision-relevant.
...
- **[DONE 2026-07-13; opened 2026-05-06] Lactoferrin disulfide-count consistency.** Propagated the Notari 2023 primary-source value of **16 disulfides** through current decision surfaces, corrected dual bulk count to 16/16 = 1.00× the Huynh reference, and corrected the UOX+Lf+DAF bulk total to 24. Historical experiment artifacts and provenance notes retain their original values where explicitly labeled as superseded history.
