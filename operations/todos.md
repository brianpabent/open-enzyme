...
## Wiki cross-page consistency cleanup (deferred from 2026-05-06 walkthrough)

- **[2026-05-06] Lactoferrin disulfide count consistency: 17 → 16 across 9+ wiki pages.** Notari 2023 (PMC10465537) explicitly states 16 disulfides for human lactoferrin; UniProt P02788 lists 34 cysteines forming 17 pairs by annotation but Notari's in vitro thiol-titration confirms 16 (32 free Cys after complete reduction = 16 pairs × 2). The chaperone-orthogonal-stacking framework's architecture-refined model (committed `22b39eb` 2026-05-06) uses Notari's 16 in §3.5 + §5.5; the framework's own §10.2 verification provenance flagged the discrepancy and explicitly chose to leave older "17 disulfides" references in other pages as scope-creep-flagged-for-later. Pages with stale "17" references: cassette-compatibility-computational.md L136; computational-experiments.md L111; aspergillus-oryzae.md L354+L358; c-utilis-uricase-cassette-compatibility-computational.md L74+L111; koji-endgame-strain.md L190+L192+L407; lactoferrin.md L330; validation-experiments.md L361+L965; GRAPH.md L430 (edge label "PDI-heavy (17 disulfides)"); hypotheses/H01-ward-dual-cassette.md L262. Single subagent run (Sonnet, ~15-20 min) can sweep them all with the canonical Notari 2023 citation anchor. Not blocking — both 16 and 17 are within UniProt's annotation range, and downstream framework calculations correctly use 16 for the architecture-refined model. Doing the propagation tightens the corpus without changing any load-bearing conclusion.
- **[2026-05-06 — RESOLVED in commit `268fa84`]** comp-006 page (`daf-cd55-protease-stability-computational.md`) had the same "3 per SCR domain (12 total)" hallucination that Item 2 fixed in comp-012 + H05 — was missed by Item 2's grep scope. Fixed during walkthrough cleanup.
- **[2026-05-06 — RESOLVED in commit `268fa84`]** Stale `ward-1995-lab-access-global.md` path in `wiki/tcm-modern-rigor-intersection.md` frontmatter `related:` list (file was renamed to `operations/ward-1995-lab-access.md` 2026-05-05). Fixed during walkthrough cleanup.
