...
- [`global-lit-scan-p0-remediation-2026-05-20/`](./global-lit-scan-p0-remediation-2026-05-20/) — first P0 remediation workspace with native-language query plans, local-curl retrieval probes, and the initial J-STAGE extraction results.
- [`reactome-audit-burndown-2026-06-01.md`](./reactome-audit-burndown-2026-06-01.md) — completed task list for using the repo-local Reactome tool to audit complement, urate transport, purine metabolism, pyroptosis, stress-response, barrier, and EPI pathway surfaces.
...
- [`reactome-nlrp3-curator-packet-2026-06-01.md`](./reactome-nlrp3-curator-packet-2026-06-01.md) — curator-facing Reactome contribution packet for oridonin, tranilast, and beta-hydroxybutyrate / 3-hydroxybutyrate regulatory annotations on the NLRP3 inflammasome pathway.
